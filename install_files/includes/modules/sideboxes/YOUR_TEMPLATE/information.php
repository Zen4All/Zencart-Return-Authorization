<?php
/**
 * Flexible Returns Authorization (RMA) Filenames
...
// forum/bb link:
  ...
  if (DEFINE_RETURNS_STATUS <= 1) {
    if(zen_is_logged_in()) {
      $information[] = '<a href="' . zen_href_link(FILENAME_ACCOUNT_HISTORY, 'action=returns_request', 'SSL') . '">' . BOX_INFORMATION_RETURNS . '</a>';
    } else {
      $information[] = '<a href="' . zen_href_link(FILENAME_RETURNS_REQUEST, '', 'SSL') . '">' . BOX_INFORMATION_RETURNS . '</a>';
    }
  }
